        ...
        >
          <div className='p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200'>
            <div className='flex items-start justify-between gap-2'>
              ...
              <button
                type='button'
                className='shrink-0 marker:text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-7 h-7 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white'
          ...
          <div className='flex items-center justify-center p-4 md:p-5 space-x-3 rtl:space-x-reverse border-t border-gray-200 rounded-b dark:border-gray-600'>
            <button
              type='button'
